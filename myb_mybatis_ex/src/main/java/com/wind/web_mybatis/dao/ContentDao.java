...
public class ContentDao implements IDao{
	...
	@Override
	public ArrayList<BookDto> book_resultDao(final String book_name){
		String query = "select * from board order by mId desc";
		ArrayList<BookDto> dtos = (ArrayList<BookDto>) template.query(query, new BeanPropertyRowMapper<BookDto>(BookDto.class));
		return dtos;
	}
